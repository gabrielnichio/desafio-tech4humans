...
class Agent:
    ...
    def html_analysis(self):
        return self.pandasExecutor.generate_html_analysis("df_final")

    def _set_tools(self):

        self.pandasExecutor = PandasExecutor(self.dataframes)
        
        get_infos = FunctionTool.from_defaults(
            self.pandasExecutor.get_infos,
            name="GetInfos",
        ...
        gera_id_unico = FunctionTool.from_defaults(
            self.pandasExecutor.gera_id_unico,
            name="GeraIDUnico",
            description="""
        ...
        rename_columns = FunctionTool.from_defaults(
            self.pandasExecutor.rename_columns,
            name="RenameColumns",
        ...
        rename_multiple_columns = FunctionTool.from_defaults(
            self.pandasExecutor.rename_multiple_dataframe_columns,
        ...
        remove_colunas = FunctionTool.from_defaults(
            self.pandasExecutor.remove_columns,
            name="RemoveColumns",
        ...
        selecionar_colunas = FunctionTool.from_defaults(
            self.pandasExecutor.select_columns,
        ...
        select_multiple_df_columns = FunctionTool.from_defaults(
            self.pandasExecutor.select_multiple_df_columns,
        ...
        soma_colunas = FunctionTool.from_defaults(
            self.pandasExecutor.soma_colunas,
            name="SomaColunas",
        ...
        soma_group_columns = FunctionTool.from_defaults(
            self.pandasExecutor.sum_column_groups,
        ...
        merge_dataframes = FunctionTool.from_defaults(
            self.pandasExecutor.merge_dataframes,
        ...
        merge_multiple_dfs = FunctionTool.from_defaults(
            self.pandasExecutor.merge_multiple_dataframes,
